<aside id="default-sidebar">
   ...
   <ul id="sidebar-content" class="font-medium">
      ...
      <li>
         <a href="/admin/jadwal" class="flex items-center justify-center py-[10px] px-[18px] h-[60px] text-white hover:bg-gray-700 group">
      ...
      <li>
         <a href="/admin/ruangan" class="flex items-center justify-center py-[10px] px-[18px] h-[60px] bg-white text-black">
            <svg class="flex justify-center items-center w-[24px] h-[24px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
