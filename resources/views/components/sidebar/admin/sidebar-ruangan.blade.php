<aside class="sidebar sidebar-offcanvas">
  ...
  <ul class="font-medium">
    ...
    <li title="Lihat semua jadwal">
      <a href="/admin/jadwal" class="text-white hover:bg-yellow-400 hover:text-blue-900 py-[10px] px-[25px]">
    ...
    <li title="Kelola daftar ruangan">
      <a href="/admin/ruangan" class="bg-yellow-400 text-blue-900 py-[10px] px-[25px]">
