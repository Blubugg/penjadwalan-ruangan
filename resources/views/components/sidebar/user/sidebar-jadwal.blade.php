<aside id="default-sidebar">
   ...
   <ul id="sidebar-content" class="font-medium">
      ...
      <li>
         <div class="flex items-center py-[7px] px-[18px] h-[70px] text-white">
            <a href="/user/jadwal/buat" class="flex items-center justify-center border border-white rounded-lg h-[46px] w-[214px]">
               <img src="{{ asset('icon/add.svg') }}" alt="navIcon">                                 
               <span class="flex justify-center items-center w-[166px] whitespace-nowrap">Buat Jadwal</span>
            </a>
         </div>
      </li>
      <li>
         <a href="/user/jadwal" class="flex items-center justify-center py-[10px] px-[18px] h-[60px] bg-white text-black">
      ...
      <li>
         <a href="/user/ruangan" class="flex items-center justify-center py-[10px] px-[18px] h-[60px] text-white hover:bg-gray-700 group">
            <svg class="flex justify-center items-center w-[24px] h-[24px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <li>
         <a href="/user/pesanan" class="flex items-center justify-center py-[10px] px-[18px] h-[60px] text-white hover:bg-gray-700 group">
            <svg class="flex justify-center items-center w-[24px] h-[24px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
